...
//..mostra a view criada            
            $array['resposta'] = "<h2 id='modalTitle'>Resposta da opera&ccedil;&atilde;o!</h2><p class='lead'>{$msg}</p><a class='close-reveal-modal' aria-label='Close'>&#215;</a><script src='core/vendor/js/foundation.reveal.js'></script><script>$(document).foundation();$(document).foundation('reveal', 'reflow');</script>";
